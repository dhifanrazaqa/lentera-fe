    ...
    <DashboardLayout>
      <div>
        ...
        <h1 className="text-sm">
          {isOpen ? "Kelas > Detail Pelajaran > Materi > " : "Kelas > Detail Pelajaran > "}
            ...
            <div className="md:col-span-5">
              <div className="bg-white p-8 rounded-md">
                ...
                <div className="my-4">
                  ...
                  <p className="text-sm">
                    Garis khayalan adalah garis yang tidak benar-benar ada,
                    tetapi kita bayangkan ada untuk membantu menjelaskan
                    sesuatu.
                    <br />
                    <br />
