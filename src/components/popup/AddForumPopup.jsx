...
import { useCreateForum } from "../../hooks/useForumQuery";
...
export default function AddForumPopup({ setIsAddOpen }) {
  const {
    control,
    handleSubmit,
    formState: { errors },
      ...
      <form onSubmit={handleSubmit(onCreatePostForum)}>
        <div className="flex items-center justify-between p-2">
          ...
          <button
            ...
            disabled={isLoading}
          >
            {isLoading ? "Loading.." : "Kirim Diskusi"}
          </button>
        </div>
        {serverError && (
          <Alert
