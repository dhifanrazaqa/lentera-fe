      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        ...
        <div className="md:col-span-5">
          <div className="bg-white p-8 rounded-md">
            ...
            <div>
              <h3 className="text-md font-semibold my-2">Ikuti Quiz Kembali</h3>
            ...
            <div>
              ...
              <BorderBoxCard color="yellow">
                <p className="text-sm">
                  Kamu bisa belajar lebih banyak melalui forum dengan mendengar
                  penjelasan dari teman-teman dan gurumu.
                </p>
              </BorderBoxCard>
            </div>
          </div>
