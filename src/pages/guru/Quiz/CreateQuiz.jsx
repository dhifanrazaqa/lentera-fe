...
export default function CreateQuiz() {
  ...
  const onSubmit = (data) => {
    console.log("Uploaded Quiz:", data);
  };
          ...
          <div className="flex flex-col md:flex-row p-4 gap-4">
            ...
            <div className="bg-white p-8 rounded-md w-full h-fit md:w-1/3">
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 h-10 bg-blue-gradient text-white rounded hover:bg-blue-600"
                >
                  Unggah Quiz
                </button>
              </div>
              {fields.map((q, index) => (
                <div
                  ...
                  className={`p-2 border rounded-md mb-2 cursor-pointer ${
                    selectedQuestionIndex === index ? "bg-blue-100" : ""
                  }`}
              ...
              {fields.length > 0 && (
                <div key={fields[selectedQuestionIndex].id} className="mb-4">
                  ...
                  {errors.questions?.[selectedQuestionIndex]?.options && (
                    <p className="text-red-500 text-sm">
                      {errors.questions[selectedQuestionIndex].options[0]?.text
                        ?.message ||
                        errors.questions[selectedQuestionIndex].options.message}
                    </p>
                  )}
